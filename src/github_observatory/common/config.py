...
# Pass-2 payload-derived aggregates from Dataproc Serverless Spark
# (see pipelines/gcp_lifecycle_backfill/ + ingestion/bq_lifecycle_history.py).
BQ_LIFECYCLE_HOURLY_TABLE = f"{BRONZE_SCHEMA}.bq_lifecycle_hourly"
